...
class SubUnitController extends Controller
{
    ...
    {
        abort_unless(Auth::user()->isAdmin() || Auth::user()->canAccess('sub_unit', 'view') || Auth::user()->canAccess('user', 'view'), 403, 'Akses Ditolak');
    ...
    {
        abort_unless(Auth::user()->isAdmin() || Auth::user()->canAccess('sub_unit', 'create') || Auth::user()->canAccess('user', 'create'), 403, 'Akses Ditolak');
        $units = \App\Models\Unit::orderBy('name', 'asc')->get();
    ...
    {
        abort_unless(Auth::user()->isAdmin() || Auth::user()->canAccess('sub_unit', 'edit') || Auth::user()->canAccess('user', 'edit'), 403, 'Akses Ditolak');
        $units = \App\Models\Unit::orderBy('name', 'asc')->get();
    ...
    {
        abort_unless(Auth::user()->isAdmin() || Auth::user()->canAccess('sub_unit', 'delete') || Auth::user()->canAccess('user', 'delete'), 403, 'Akses Ditolak');
        $subUnit->delete();
