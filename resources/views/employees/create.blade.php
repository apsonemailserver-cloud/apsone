...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="py-4">
        ...
        {{-- Card Form Create Employee --}}
        <div class="card mb-4">
            <div class="card-header border-bottom">
                <h5 class="mb-0 fw-bold">Tambah Karyawan Baru</h5>
            </div>
            <div class="card-body pt-4">
                ...
                <form action="{{ route('employees.store') }}" method="POST" id="createEmployeeForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 border-end-md">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">NIP dibuat otomatis oleh sistem</small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="no_nik" id="no_nik"
                                    placeholder="Masukkan nomor NIK KTP" value="{{ old('no_nik') }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="pendidikan" id="pendidikan"
                                    placeholder="Contoh: SMA / SMK / D3 / S1" value="{{ old('pendidikan') }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="domisili" id="domisili"
                                    placeholder="Masukkan domisili tempat tinggal saat ini" value="{{ old('domisili') }}">
                            </div>
                        </div>
                                ...
                                <select name="station_id" id="station_id" class="form-select" required>
                                    ...
                                    @foreach ($stations as $station)
                                        <option value="{{ $station->code }}"
                                            {{ old('station_id', old('station')) == $station->code ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="sub_unit_id" id="sub_unit_id" class="form-select" required>
                                    ...
                                    @foreach ($subUnits as $su)
                                        <option value="{{ $su->id }}" data-unit-id="{{ $su->unit_id }}" {{ old('sub_unit_id') == $su->id ? 'selected' : '' }}>
                                            {{ $su->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="cluster_id" id="cluster_id" class="form-select">
                                    ...
                                    @foreach ($clusters as $c)
                                        <option value="{{ $c->id }}" {{ old('cluster_id') == $c->id ? 'selected' : '' }}>
                                            {{ $c->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row g-2 mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="number" class="form-control" name="salary" id="salary"
                                        placeholder="Contoh: 5000000" value="{{ old('salary') }}">
                                </div>
                            </div>
                            ...
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    ...
                                    <select name="status" class="form-select">
                                        <option value="Employed" {{ old('status', 'Employed') == 'Employed' ? 'selected' : '' }}>Employed</option>
                            ...
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="bpjs_tk" id="bpjs_tk"
                                        placeholder="Nomor BPJS TK" value="{{ old('bpjs_tk') }}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">BPJS Kesehatan</label>
                                    <input type="text" class="form-control" name="bpjs_kesehatan" id="bpjs_kesehatan"
                                        placeholder="Nomor BPJS Kesehatan" value="{{ old('bpjs_kesehatan') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-top mt-3">
                        <x-form-actions :cancelHref="route('employees.index')" submitText="Simpan Data Karyawan" />
                    </div>
                </form>
            </div>
        </div>
