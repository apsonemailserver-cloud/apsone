                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="station_id" class="form-select" required>
                            ...
                            <option value="{{ $st->code }}" {{ old('station_id', old('station', $employee->station_id)) == $st->code ? 'selected' : '' }}>{{ $st->code }} - {{ $st->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="sub_unit_id" id="sub_unit_id" class="form-select" required>
                            ...
                            <option value="{{ $su->id }}" data-unit-id="{{ $su->unit_id }}" {{ old('sub_unit_id', $employee->sub_unit_id) == $su->id ? 'selected' : '' }}>{{ $su->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="card-body pt-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="pas_registered" class="form-control" value="{{ old('pas_registered', $employee->pas_registered ? $employee->pas_registered->format('Y-m-d') : '') }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">PAS Expired</label>
                        <input type="date" name="pas_expired" class="form-control" value="{{ old('pas_expired', $employee->pas_expired ? $employee->pas_expired->format('Y-m-d') : '') }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">No PAS</label>
                        <input type="text" name="no_pas" class="form-control" value="{{ old('no_pas', $employee->no_pas) }}">
                    </div>
                    <div class="col-md-4">
...
(function() {
    function initUnitSubUnitFilter() {
        ...
        function filterSubUnits() {
            ...
            const currentVal = String(subUnitSelect.value || "{{ old('sub_unit_id', $employee->sub_unit_id) }}").trim();
