                ...
                <ul class="menu-inner py-1">
                    ...
                    <li
                        ...
                        <ul class="menu-sub">
                            ...
                            @if (Auth::user()->canAccess('attendance', 'approve') || (\Illuminate\Support\Facades\Schema::hasTable('employees') && \App\Models\Employee::where('manager', Auth::user()->fullname)->exists()))
            ...
            <div class="layout-page">
                @php
                    ...
                    $canApproveAttendanceCorrections = in_array('Admin', array_map('trim', explode(',', (string) $currentUser->role)), true)
                        || (\Illuminate\Support\Facades\Schema::hasTable('employees') && \App\Models\Employee::where('manager', $currentUser->fullname)->exists());
